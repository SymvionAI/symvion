...
from app.runtime.utils.document_storage import get_document_storage
from app.runtime.utils.ocr_service import get_ocr_service
...
class DocumentIntelligenceAgent:
    ...
    def __init__(self, tenant_id: str, config: Dict[str, Any] = None):
        ...
        temperature = float(
            self.config.get("temperature", os.getenv("LLM_TEMPERATURE", "0.7"))
        )
