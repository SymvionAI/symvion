...
from symvion.tools.mcp_client import get_mcp_client, MCP_SERVERS
...
class ToolWrapper:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            allowed_outbound_hosts: Optional host allowlist for MCP HTTP
    ...
    async def call_tool(
        ...
        mcp_client = get_mcp_client(
            mcp_server_name,
            allowed_outbound_hosts=self.allowed_outbound_hosts,
            file_sandbox_dir=self.file_sandbox_dir,
        )
        if not mcp_client:
