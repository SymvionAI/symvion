...
from symvion.agents.legacy_agent.doctrine_cache import get_principles
from symvion.agents.legacy_agent.doctrine_engine import _normalize_document_view
...
class LegacyAgent:
    ...
    async def evaluate(
        ...
        try:
            ...
            from symvion.agents.legacy_agent.doctrine_models import empty_evaluation
